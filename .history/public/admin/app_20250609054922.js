    ...
    function updateSalesTable(data) {
        ...
        data.forEach(row => {
            ...
            tr.innerHTML = `
                ...
                <td>$${row.coin.toFixed(2)}</td>
                <td>$${row.hopper.toFixed(2)}</td>
                <td>$${row.soap.toFixed(2)}</td>
                <td>$${row.vending.toFixed(2)}</td>
                <td>$${row.drop_off_1.toFixed(2)}</td>
                <td>$${row.drop_off_2.toFixed(2)}</td>
                <td>$${row.drop_off_3.toFixed(2)}</td>
            `;
        ...
        const total = data.reduce((sum, row) => {
            return sum + row.coin + row.hopper + row.soap + row.vending + 
