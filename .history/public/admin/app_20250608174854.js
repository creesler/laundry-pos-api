...
(function(app) {
    ...
    function renderEmployeeTabs() {
        ...
        if (!employees || employees.length === 0) {
            console.log('No employees to render tabs for');
            return;
        }
        ...
        employees.forEach(employee => {
            ...
            if (employee.status === 'active') {
                ...
                console.log(`Created tab for employee: ${employee.name}`);
            }
        });
    }
    ...
    function selectEmployee(employeeName) {
        ...
        if (employee) {
            ...
            console.log('Selected employee not found or inactive:', employeeName);
