...
async function testDeletion() {
  try {
    ...
    // 2. Create a test item directly in MongoDB
    console.log('\nCreating test item...');
    const createdItem = await Inventory.create(TEST_ITEM);
    ...
    const syncResponse = await axios.post('http://localhost:5000/api/sync', {
