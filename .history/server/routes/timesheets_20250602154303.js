...
// @route   GET /api/timesheets/employee/:employeeName
...
router.get('/employee/:employeeName', async (req, res) => {
  try {
    ...
    console.log('Timesheet request received:', { employeeName, startDate, endDate });
    ...
    // Create date range - ensure we get the full days
    ...
    console.log('Searching timesheets between:', {
    ...
    console.log(`Found ${timesheets.length} timesheet entries for ${employeeName}`);
