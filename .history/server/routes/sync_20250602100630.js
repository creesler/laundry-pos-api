...
router.post('/', async (req, res) => {
  ...
  try {
      ...
      try {
        for (const item of inventory) {
          ...
          try {
            ...
            // Include both frontend ID and MongoDB ID in response
            savedInventory.push({
    ...
    // Send response with counts, any errors, and ID mappings
    res.json({ 
      ...
      savedInventory, // Now includes both frontend and MongoDB IDs
