        ...
        for (const item of inventoryToUpdate) {
          ...
          try {
            ...
            if (item.id && item.id.startsWith('local-')) {
              ...
              console.log('Creating new inventory item from local data:', itemData);
              const newItem = new Inventory(itemData);
              const savedItem = await newItem.save();
              console.log('Created new inventory item:', savedItem.toObject());
              ...
              if (updatedItem) {
                console.log('Updated inventory item:', updatedItem.toObject());
