...
router.get('/summary', async (req, res) => {
  try {
    ...
    if (isNaN(startDateTime.getTime()) || isNaN(endDateTime.getTime())) {
      ...
      return res.status(400).json({ msg: 'Invalid date format. Please use ISO format (YYYY-MM-DD)' });
    }

    console.log('Fetching sales summary between:', {
    ...
    console.log('Sales summary results:', results);
