...
export default function Home() {
  ...
  useEffect(() => {
    const loadInventoryData = async () => {
      try {
        console.log('[INVENTORY LOAD START] Loading inventory data from IndexedDB');
        const data = await getFromIndexedDB();
        if (data?.inventory) {
          console.log('[INVENTORY LOAD] Setting inventory from IndexedDB:', data.inventory);
          setInventoryItems(data.inventory);
        } else {
          console.log('[INVENTORY LOAD] No inventory found, initializing defaults');
          ...
          console.log('[INVENTORY LOAD] Saving default items to IndexedDB');
        ...
        if (data?.inventoryLogs) {
          console.log('[INVENTORY LOAD] Setting inventory logs from IndexedDB:', data.inventoryLogs);
