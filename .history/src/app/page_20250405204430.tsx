...
export default function Home() {
  ...
  const handleSave = () => {
    ...
    const newRow = {
      ...
      'Drop Off 1 Amount': inputValues['Drop Off 1'],
      'Drop Off 1 Code': inputValues['Drop Off Code 1'],
      'Drop Off 2 Amount': inputValues['Drop Off 2'],
      'Drop Off 2 Code': inputValues['Drop Off Code 2'],
    }
    ...
    try {
      ...
      let worksheet = workbook.Sheets['Daily Tracker'] || XLSX.utils.aoa_to_sheet([
        ['Date/Time', 'Coin', 'Hopper', 'Soap', 'Vending', 'Drop Off 1 Amount', 'Drop Off 1 Code', 'Drop Off 2 Amount', 'Drop Off 2 Code']
      ])
        ...
        <Box sx={{ 
          ...
          <Paper sx={{ 
            ...
            <Box sx={{ 
              ...
              {[1, 2].map((num) => (
                <Box key={num} sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1vh' }}>
                  <TextField
                    size="small"
                    placeholder={`Drop Off ${num}`}
                    value={inputValues[`Drop Off ${num}`]}
                    onClick={() => setSelectedField(`Drop Off ${num}`)}
                    inputProps={{ 
                      style: { fontSize: '1.8vh' },
                      readOnly: true
                    }}
                    sx={{
                      '& .MuiOutlinedInput-root': {
                        height: '4vh',
                        borderRadius: '6px',
                        bgcolor: selectedField === `Drop Off ${num}` ? '#e8f0fe' : 'transparent',
                        '& fieldset': {
                          borderColor: selectedField === `Drop Off ${num}` ? blue[500] : '#e5e7eb'
                        }
                      }
                    }}
                  />
                  <TextField
                    size="small"
                    placeholder="Code"
                    value={inputValues[`Drop Off Code ${num}`]}
                    onClick={() => setSelectedField(`Drop Off Code ${num}`)}
                    inputProps={{ 
                      style: { fontSize: '1.8vh' },
                      readOnly: true
                    }}
                    sx={{
                      '& .MuiOutlinedInput-root': {
                        height: '4vh',
                        borderRadius: '6px',
                        bgcolor: selectedField === `Drop Off Code ${num}` ? '#e8f0fe' : 'transparent',
                        '& fieldset': {
                          borderColor: selectedField === `Drop Off Code ${num}` ? blue[500] : '#e5e7eb'
                        }
                      }
                    }}
                  />
