...
import { SnackbarState, InputValues, InventoryItem, InventoryUpdateLog, SalesRecord } from './types'
...
export default function Home() {
    ...
    const loadData = async () => {
      try {
        ...
        if (indexedDBData?.data) {
          ...
          // Also set employee list if available
          if (indexedDBData.employeeList?.length) {
  ...
  // Save data to IndexedDB whenever savedData changes
  useEffect(() => {
