  ...
  return (
    <Paper sx={{ ...sx, p: '1.5vh', display: 'flex', flexDirection: 'column', borderRadius: '8px', border: '1px solid #e5e7eb', minHeight: 0, overflow: 'hidden', boxShadow: '0 1px 2px rgba(0,0,0,0.05)' }}>
      ...
      <Box sx={{ 
        ...
        gap: { xs: '0.5vh', sm: '0.8vh' },
        mb: { xs: '0.5vh', sm: '0.8vh' }
      }}>
        ...
        <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: { xs: '0.5vh', sm: '0.8vh' }, gridColumn: 'span 2' }}>
          <TextField
            size="small"
      ...
      <Box sx={{ 
        ...
        flex: 1,
        '& .MuiButton-root': {
          fontSize: { xs: '2.2vh', sm: '2.5vh', md: '3vh' },
          minHeight: { xs: '4.5vh', sm: '5vh', md: '6vh' },
          padding: { xs: '0.5vh', sm: '1vh' },
          borderRadius: '8px',
          fontWeight: 'bold',
