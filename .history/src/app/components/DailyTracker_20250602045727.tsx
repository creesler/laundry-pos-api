...
const TableRow = memo(({ 
  ...
  row: DailyTrackerProps['savedData'][0]
  index: number
  editingIndex: number | null
  onEdit: (index: number) => void 
}) => (
...
// Memoize the entire DailyTracker component
export default memo(function DailyTracker({ savedData, editingIndex, onEdit, sx }: DailyTrackerProps) {
  return (
