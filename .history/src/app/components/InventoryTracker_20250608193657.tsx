...
import { InventoryItem, InventoryUpdateLog } from '../types';

interface InventoryTrackerProps {
  sx?: SxProps;
  inventory: InventoryItem[];
  logs: InventoryUpdateLog[];
  onUpdateStock: (itemId: string, newStock: number, updateType: 'restock' | 'usage' | 'adjustment', notes?: string) => Promise<void>;
  onAddItem: (newItem: Omit<InventoryItem, 'id' | 'lastUpdated'>) => Promise<void>;
