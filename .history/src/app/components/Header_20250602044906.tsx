        ...
        <DialogContent>
          ...
          {(() => {
            ...
            return (
              <TextField
                autoFocus
                margin="dense"
                label={`Soap Used (${soapAvailable} bottles available)`}
                type="number"
                fullWidth
                value={soapUsage}
                onChange={(e) => setSoapUsage(e.target.value)}
                disabled={soapAvailable <= 0}
                helperText={soapAvailable <= 0 ? "No stock available" : ""}
                InputProps={{
          ...
          {(() => {
            ...
            return (
              <TextField
                margin="dense"
                label={`Detergent Used (${detergentAvailable} boxes available)`}
                type="number"
                fullWidth
                value={detergentUsage}
                onChange={(e) => setDetergentUsage(e.target.value)}
                disabled={detergentAvailable <= 0}
                helperText={detergentAvailable <= 0 ? "No stock available" : ""}
                InputProps={{
