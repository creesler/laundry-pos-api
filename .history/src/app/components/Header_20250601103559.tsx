          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: '1vh' }}>
            ...
            <Stack direction="row" spacing={1}>
              <Button
                ...
                sx={{
                  bgcolor: !clockedIn ? green[600] : grey[400],
                  '&:hover': { bgcolor: !clockedIn ? green[700] : grey[400] }
                }}
              >
              ...
              <Button
                variant="contained"
                onClick={() => saveEmployeeTimeLocally('out')}
                disabled={!clockedIn || isClockingOut}
                sx={{
                  bgcolor: clockedIn ? red[600] : grey[400],
                  '&:hover': { bgcolor: clockedIn ? red[700] : grey[400] }
                }}
              >
