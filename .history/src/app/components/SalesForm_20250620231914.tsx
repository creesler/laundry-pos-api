  ...
  return (
    <Paper sx={{ ...sx, p: '1.5vh', display: 'flex', flexDirection: 'column', borderRadius: '8px', border: '1px solid #e5e7eb', minHeight: 0, overflow: 'hidden', boxShadow: '0 1px 2px rgba(0,0,0,0.05)' }}>
      ...
      <Box sx={{ 
        ...
        gap: { xs: '0.5vh', sm: '0.6vh', md: '0.8vh' },
        mb: { xs: '0.5vh', sm: '0.6vh', md: '0.8vh' }
      }}>
          ...
          <TextField
            ...
            sx={{
              '& .MuiOutlinedInput-root': {
                height: { xs: '3.5vh', sm: '4vh', md: '4.5vh' },
                borderRadius: '4px',
      ...
      <Box sx={{ 
        ...
        '& .MuiButton-root': {
          ...
          minHeight: { xs: '4.5vh', sm: '5vh', md: '6vh' },
          borderRadius: { xs: '6px', sm: '7px', md: '8px' },
          fontWeight: 'bold',
          boxShadow: '0 2px 4px rgba(0,0,0,0.08)',
          bgcolor: '#FFFFFF',
          color: '#000000',
          padding: { xs: '0.5vh', sm: '1vh', md: '1.5vh' },
          '&:hover': { 
            bgcolor: '#F8F9FA'
          }
        }
        ...
        <Button
          ...
          sx={{
            ...
            fontSize: { xs: '1.8vh', sm: '2vh', md: '2.2vh' } // Slightly smaller font for DEL
          }}
        >
          DEL
        </Button>
        <Button
          ...
          sx={{
            ...
            fontSize: { xs: '1.8vh', sm: '2vh', md: '2.2vh' } // Slightly smaller font for CLR
          }}
        >
          CLR
        </Button>
        ...
        <Button
          ...
          sx={{
            ...
            fontSize: { xs: '1.8vh', sm: '2vh', md: '2.2vh' } // Slightly smaller font for SAVE
          }}
        >
          SAVE
        </Button>
