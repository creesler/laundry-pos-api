    ...
    <Paper sx={{ ...sx, p: '1.5vh', display: 'flex', flexDirection: 'column', borderRadius: '8px', border: '1px solid #e5e7eb', boxShadow: '0 1px 2px rgba(0,0,0,0.05)' }}>
      ...
      <Box sx={{ 
        ...
        {inventory.map((item) => {
          ...
          const isLowStock = usagePercentage >= 80;
                ...
                <LinearProgress
                  ...
                  sx={{
                    ...
                    '& .MuiLinearProgress-bar': {
                      bgcolor: isLowStock ? 'warning.main' : getStockLevelColor(item)
                    }
                  }}
                />
              </Box>
      ...
      >
        <DialogTitle sx={{ fontSize: '1.8vh', py: '1.2vh' }}>
          Delete Item
        </DialogTitle>
        <DialogContent sx={{ py: '1.2vh' }}>
