...
export default function Home() {
  ...
  // Add handler for email change
  const handleEmailChange = (event) => {
    setEmail(event.target.value)
  }

  // Add handler for email save
    ...
    try {
      ...
      reader.onload = async () => {
        ...
        const templateParams = {
          ...
          from_name: 'Laundry King POS',
          message: 'Please find attached the laundry sales data.',
  ...
  const handleEmailShare = () => {
    ...
    const subject = 'Laundry Sales Report'
    const body = `Total Sales: $${calculateDailyTotals().reduce((sum, day) => sum + (day.total / 50), 0).toFixed(2)}`
              ...
              >
                ...
                >
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, width: '100%' }}>
                    ...
                    <Typography>Email Report</Typography>
                  </Box>
                  {isEditingEmail ? (
