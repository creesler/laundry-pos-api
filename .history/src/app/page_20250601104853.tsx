...
export default function Home() {
  ...
  const saveToServer = async () => {
    try {
      ...
      // Only update the isSaved flag for the timesheet entries
      const updatedTimeData = employeeTimeData.map(entry => 
      ...
      // Save to IndexedDB while preserving existing sales data
      const existingData = await getFromIndexedDB() || {};
      await saveToIndexedDB({
        ...existingData,
        employeeTimeData: updatedTimeData,
      ...
      // Only fetch updated employee list, not sales data
