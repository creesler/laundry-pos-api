...
export default function Home() {
  ...
  const saveToServer = async () => {
    try {
      ...
      // Find changes
      const newEmployees = serverEmployeeNames.filter((emp: string) => !employeeList.includes(emp));
      const deletedEmployees = employeeList.filter((emp: string) => !serverEmployeeNames.includes(emp));
