...
export default function Home() {
  const [timeIn, setTimeIn] = useState<string>('10:00 PM')
  ...
  const sendEmailWithCSV = async () => {
    try {
      ...
      mailtoLink.href = `mailto:creesler@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`
