  ...
  const saveToServer = async () => {
    try {
      ...
      try {
        ...
        // Find changes
        const newEmployees = serverEmployeeNames.filter(emp => !localEmployeeList.includes(emp));
        const deletedEmployees = localEmployeeList.filter(emp => !serverEmployeeNames.includes(emp));
