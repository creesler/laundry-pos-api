...
export default function Home() {
  ...
  const renderChart = () => {
    const chartData = calculateDailyTotals(savedData, viewType, selectedMonth, selectedYear)
        ...
        <Box sx={{
          ...
          <Box sx={{ 
            ...
            <SalesChart
              ...
              calculateDailyTotals={() => calculateDailyTotals(savedData, viewType, selectedMonth, selectedYear)}
              yearItems={yearItems}
            />
