            ...
            <Box component="table" sx={{ 
              ...
              <Box component="thead">
                <Box component="tr">
                  ...
                  <Box component="th">Hopper</Box>
                  <Box component="th">Soap</Box>
                  <Box component="th">Vending</Box>
                  <Box component="th" colSpan={3} sx={{ borderBottom: '2px solid #e5e7eb' }}>Drop Off</Box>
                </Box>
                <Box component="tr">
              ...
              <Box component="tbody">
                {/* This will be populated with saved data */}
                <Box component="tr">
                  <Box component="td">4/5/2025</Box>
                  <Box component="td">150.00</Box>
                  <Box component="td">75.00</Box>
                  <Box component="td">25.00</Box>
                  <Box component="td">50.00</Box>
                  <Box component="td">18.00</Box>
                  <Box component="td">23</Box>
                  <Box component="td">6.75</Box>
                </Box>
                <Box component="tr">
                  <Box component="td">4/5/2025</Box>
                  <Box component="td">120.00</Box>
                  <Box component="td">60.00</Box>
                  <Box component="td">30.00</Box>
                  <Box component="td">45.00</Box>
                  <Box component="td">10.00</Box>
                  <Box component="td">24</Box>
                  <Box component="td">5.00</Box>
                </Box>
              </Box>
            </Box>
          </Paper>
