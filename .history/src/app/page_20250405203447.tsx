    ...
    <Box sx={{ 
      ...
      <Box sx={{ 
        ...
        <Paper sx={{ 
          ...
          <Typography fontSize="1.8vh" fontWeight="medium" mb="1.5vh">Daily Tracker</Typography>
        ...
        <Paper sx={{ 
          ...
          <Typography fontSize="1.8vh" fontWeight="medium" mb="1.5vh">April 5, 2025</Typography>
          <Box sx={{ 
            display: 'grid',
        ...
        <Paper sx={{ 
          ...
          <Typography fontSize="1.8vh" fontWeight="medium" mb="1.5vh">Monthly Sales</Typography>
          <Box sx={{ 
            display: 'flex',
            gap: '1.5vh',
            alignItems: 'flex-end',
        ...
        <Paper sx={{ 
          ...
          <Typography fontSize="1.8vh" fontWeight="medium" mb="1.5vh">Inventory</Typography>
