...
export default function Home() {
  ...
  const calculateDailyTotals = () => {
    ...
    // Convert to array and sort by date (oldest first for proper chart display)
  ...
  const calculateChartWidth = () => {
    ...
    // - Left margin: 65px
    // - Right margin: 15px
    // - Each data point: 40px width
    // - Subtract 1 data point width to account for the last point alignment
    ...
    const totalWidth = Math.max(
      800, // minimum width
      leftMargin + (dataPoints * pointWidth) - pointWidth + rightMargin
    )
          ...
          <Paper sx={{ 
            ...
            <Box sx={{ 
              ...
              <Box sx={{ 
                ...
                <Box sx={{
                  overflowX: timePeriod === 'year' ? 'auto' : 'hidden',
                  overflowY: 'hidden',
                  pb: '8px', // Add padding to prevent scrollbar from hiding dates
                  '&::-webkit-scrollbar': {
                    height: '6px',
                      ...
                      <Box sx={{
                        ...
                        {calculateDailyTotals().map((item, index) => (
                          <Typography 
                            ...
                            sx={{
                              textAlign: 'center',
                              minWidth: timePeriod === 'year' ? '40px' : '30px',
                              whiteSpace: 'nowrap'
                            }}
                          >
                            {item.date}
