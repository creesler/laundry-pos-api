...
export default function Home() {
  ...
  const handleSave = () => {
    ...
    try {
      ...
      // Update saved data state first
      const updatedData = [...savedData, newRow]
      setSavedData(updatedData)

      // Then save to localStorage as JSON
      ...
      // Clear inputs and selected field
              ...
              <table>
                <thead>
                  <tr>
                    ...
                    <th style={{ width: '11%' }}>Hopper</th>
                    <th style={{ width: '11%' }}>Soap</th>
                    <th style={{ width: '11%' }}>Vending</th>
                ...
                <tbody>
                  {savedData.map((row, index) => (
                    <tr key={index}>
                      ...
                      <td style={{ width: '11%' }}>{row.Coin}</td>
                      <td style={{ width: '11%' }}>{row.Hopper}</td>
                      <td style={{ width: '11%' }}>{row.Soap}</td>
                      <td style={{ width: '11%' }}>{row.Vending}</td>
