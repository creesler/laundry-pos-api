...
export default function Home() {
  ...
  const saveToServer = async () => {
    try {
      ...
      // Force a re-render of the employee dropdown
      const employeeSelect = document.querySelector('select') as HTMLSelectElement;
      if (employeeSelect) {
        employeeSelect.innerHTML = serverEmployeeNames
